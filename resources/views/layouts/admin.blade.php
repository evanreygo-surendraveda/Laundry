...
<head>
    ...
    <title>{{ config('app.name', 'Wash') }}</title>
    ...
    <!-- Favicon -->
    <link href="{{ asset('img/laundry.png') }}" rel="icon" type="image/png">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
            ...
            <div class="sidebar-brand-text mx-3">Wash <sup>2</sup></div>
        </a>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Pilih "Logout" dibawah apabila anda ingin mengakhiri sesi ini.</div>
